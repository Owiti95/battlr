...
function FetchData() {
    ...
    useEffect(() => {
        axios.get('https://j-ashy-eight.vercel.app/bots')
    ...
    const handleDeleteClick = (botId) => {
        axios.delete(`https://j-ashy-eight.vercel.app/bots/${botId}`)
        .then(() => {
  ...
  return (
    <div className='container'>
        <div className='mt-3'>
            <h2 className='text-3xl font-bold underline'>Bots Collection</h2>
